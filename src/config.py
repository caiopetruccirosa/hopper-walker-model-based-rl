...
HEALTHY_REWARD = 1          # reward given at every step agent is healthy
FORWARD_REWARD_WEIGHT = 1   # reward for moving foward, which is positive when agent is moving forward and negative when moving side-ways or backwards
CTRL_COST_WEIGHT = 1e-3     # negative reward to penalize agent taking large actions

# History tracking and checkpoint variables
CHECKPOINT_FREQUENCY = 200         # checkpoint frequency of the training history and the agent
